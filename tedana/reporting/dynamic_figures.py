...
TR = 2
out_dir = '/Users/enekourunuela/test_data/NIH_5_echo/'
...
def tap_callback(comptable_ds, CDS_meica_ts, CDS_meica_fft,
    ...
    var colors   = source_comp_table.colors;
    ...
    var selected_color = colors[selected_padded_C]
...
generate_report(kr_div, kr_script, file_path='/Users/enekourunuela/report_v3.html')
